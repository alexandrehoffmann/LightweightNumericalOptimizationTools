...
template<typename LineSearch, NLCGUpdateStrategy UpdateStrategy = NLCGUpdateStrategy::HESTENES_STIEFEL, typename ConvergenceCriterion = L2Norm<ScalarFor<LineSearch>>> 
