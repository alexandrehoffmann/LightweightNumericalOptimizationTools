...
auto LanczosTRSSolverBase<Derived>::solveImpl(HesOp&& H, PrecOp&& invB, const Scalar* g, const ASize size, const Scalar& delta, Scalar* x) -> Scalar requires(areHessianOps<HesOp,PrecOp> and isSize<ASize>)
{
	using AdlMath::abs;
	using AdlMath::sqrt;
